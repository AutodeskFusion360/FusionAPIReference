...
# ifdef __COMPILING_ADSK_SIM_NASTRANCONTACT_CPP__
# define ADSK_SIM_NASTRANCONTACT_API XI_EXPORT
# else
# define ADSK_SIM_NASTRANCONTACT_API
# endif
#else
# define ADSK_SIM_NASTRANCONTACT_API XI_IMPORT
#endif
...
/// !!!!! Warning !!!!!
/// 
/// Contact in Nastran-based studies (Static Stress, Nonlinear Static Stress).
class NastranContact : public Contact {
public:
    ...
    ADSK_SIM_NASTRANCONTACT_API static const char* classType();
    ADSK_SIM_NASTRANCONTACT_API const char* objectType() const override;
    ADSK_SIM_NASTRANCONTACT_API void* queryInterface(const char* id) const override;
    ADSK_SIM_NASTRANCONTACT_API static const char* interfaceId() { return classType(); }
...
inline bool NastranContact::isSymmetric() const
{
    bool res = isSymmetric_raw();
    return res;
}

inline bool NastranContact::isAutoMaxActivationDistance() const
{
    bool res = isAutoMaxActivationDistance_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::stiffnessFactor() const
{
    core::Ptr<OptionalDouble> res = stiffnessFactor_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::coefficientOfStaticFriction() const
{
    core::Ptr<OptionalDouble> res = coefficientOfStaticFriction_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::maxActivationDistance() const
{
    core::Ptr<OptionalDouble> res = maxActivationDistance_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::thermalConductance() const
{
    core::Ptr<OptionalDouble> res = thermalConductance_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::penetrationSurfaceOffset() const
{
    core::Ptr<OptionalDouble> res = penetrationSurfaceOffset_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::maxAllowablePenetration() const
{
    core::Ptr<OptionalDouble> res = maxAllowablePenetration_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::frictionalStiffnessForStick() const
{
    core::Ptr<OptionalDouble> res = frictionalStiffnessForStick_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::maxAllowableAdjustmentRatio() const
{
    core::Ptr<OptionalDouble> res = maxAllowableAdjustmentRatio_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::allowablePenetrationLowerBoundRatio() const
{
    core::Ptr<OptionalDouble> res = allowablePenetrationLowerBoundRatio_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::maxRadialActivationDistance() const
{
    core::Ptr<OptionalDouble> res = maxRadialActivationDistance_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::maxNormalActivationDistance() const
{
    core::Ptr<OptionalDouble> res = maxNormalActivationDistance_raw();
    return res;
}

inline core::Ptr<OptionalDouble> NastranContact::maxAllowableSlip() const
{
...
#undef ADSK_SIM_NASTRANCONTACT_API